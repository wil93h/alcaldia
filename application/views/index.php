				...
				<div class="overlay">
					<div class="container">
						<div class="row">
							...
							<div class="sec-title text-center white wow animated fadeInDown">
								<h2>Siguenos</h2>
								<p>Encuentranos en las diferentes redes sociales</p>
							</div>

							<ul class="social-button">
								<li class="wow animated zoomIn"><a href="https://www.facebook.com/Alcald%C3%ADa-Municipal-Villa-El-Refugio-850229401712662/?fref=ts"><i class="fa fa-thumbs-up fa-2x"></i></a></li>
								<li class="wow animated zoomIn" data-wow-delay="0.3s"><a href="http://www.twitter.com"><i class="fa fa-twitter fa-2x"></i></a></li>
								<li class="wow animated zoomIn" data-wow-delay="0.6s"><a href="http://www.instagram.com"><i class="fa fa-dribbble fa-2x"></i></a></li>
							</ul>
			...
			<section id="contact" >
				<div class="container">
					<div class="row">
						...
						<div class="sec-title text-center wow animated fadeInDown">
							<h2><span class="subrayadoAzul">Contact</span></h2>
							<p>Leave a Message</p>
						</div>
						...
						<div class="col-md-5 wow animated fadeInRight">
							<address class="contact-details">
								<h3 class="subrayadoAzul">Contact Us</h3>
